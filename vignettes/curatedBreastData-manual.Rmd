---
title: "curatedBreastData Manual"
author: "Katie Planey"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{curatedBreastData Manual}
...
![Effect sizes of a selected gene showing how different sites (batches) from the same study can have different end effect size results (with survival as the meta-analysis outcome variable.)](batchEffects.jpg)
...
![microarray_processing](microarray_processing.jpg)
...
2. Github repo with code, further documentation on datasets and baseline normalization schemes, and database quality checks: 
